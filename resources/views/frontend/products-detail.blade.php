...
<meta property="og:image"
    content="https://derma-express.com/assets/admin/assets/media/derma_produk/500/{{ $data->image }}" />
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" style="font-size: 8px !important;"><a href="{{ url('products') }}">Produk</a></li>
                <li class="breadcrumb-item active" style="font-size: 8px !important;" aria-current="page">{{ $data->getProdukLanguage->judul }}</li>
            </ol>
        </nav>
        <br /><br />
    </div>
    ...
    <div class="container" id="container_luar">
        <div class="container" id="container_dalem">
            <div class="section topmargin nobottommargin nobottomborder"
                style="margin: 0 !important; background-color: #ffffff !important; padding-top: 0 !important">
                <div class="container" id="container_detail">
                    <div class="row">
                        <div class="col-lg-6 col-sm-12 xzysui"
                            style="border-radius: 5px; margin-bottom: 10px;  padding: 60px; padding-top: 0px;">
                            <div class="img-magnifier-container">
                                <img class="img-home" id="img-home" width="100%"
                                    src="{{ asset('assets/admin/assets/media/derma_produk/') }}/{{ $data->image }}"
                                    alt="{{ $data->getProdukLanguage->judul }}" style="border-radius: 5px;">

                                <input type="hidden" id="img-home-before"
                                    value="{{ asset('assets/admin/assets/media/derma_produk/') }}/{{ $data->image }}"
                                    alt="{{ $data->getProdukLanguage->judul }}">
                            </div>

                            <br />
                            <img class="img-home" id="img-produk-0" width="100%"
                                src="{{ asset('assets/admin/assets/media/derma_produk/') }}/{{ $data->image }}"
                                alt="{{ $data->getProdukLanguage->judul }}" style="border-radius: 5px; width: 16%;"
                                onmouseover="setImage(this, '0')" onmouseleave="changeImage(this, 0)"
                                onclick="setThis(this, '0')">

                            <?php $i = 1; foreach ($detailGambar as $item) { $i++; ?>
                            <img class="img-home" id="img-produk-{{ $i }}" width="100%"
                                src="{{ asset('assets/admin/assets/media/derma_produk/') }}/{{ $item->image }}"
                                alt="{{ $data->getProdukLanguage->judul }}" style="width: 16%; border-radius: 5px;"
                                onmouseover="setImage(this, '{{ $i }}')" onmouseleave="changeImage(this, '{{ $i }}')"
                                onclick="setThis(this, '{{ $i }}')">
                            <?php } ?>
                        </div>
                        ...
                        <div class="col-lg-6 col-sm-12" style="font-size: 18px;">
                            ...
                            <span
                                style="font-size: 25px; font-weight: bold; font-family: ui-monospace; margin-bottom: 10px;">
                                @if($data->harga != 0)
                            ...
                            <table class="detail-spec-web"
                                style="text-align: center; background-color: #92cac3; border-radius: 7px;">
                                @foreach($data->getSpec as $key => $val)
                                    ...
                                    @if($key == (count($data->getSpec)-1))
                                        ...
                                        <td width="50%">
                                    @endif
                                    <img src="{{ asset('assets/admin/assets/media/derma_produk_spec') }}/{{ $val->icon_dark }}"
                                        alt="" style="width: 30px; margin: 16px 30px 22px 24px;">
                                    <span
                                        style="color: white; font-size: 15px; font-family: ui-sans-serif;">{{ $val->specification }}</span>
                                    </td>
                                    @if(($key % 2) == 0)
                                        </tr>
                                    @endif
                            ...
                            <table class="detail-spec-mobile" style="background-color: #92cac3; border-radius: 7px;">
                                @foreach($data->getSpec as $key => $val)
                                    <tr>
                                        ...
                                        <td align="center"
                                            style="color: white; font-size: 15px; font-family: ui-sans-serif;">
                            ...
                            <a href="https://wa.me/+6282260030880/?text=Pesanan Kamu {{ $data->getProdukLanguage->judul }}, Silahkan melakukan proses check out."
                                class="btn btn-info" style="background-color: rgb(16, 158, 158); width: 100%;"
                                target="_blank">Miliki Sekarang</a>
                        </div>
                    </div>
                </div>
            </div>
