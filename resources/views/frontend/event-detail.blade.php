...
<div class="section nobg nobottommargin clearfix" style="margin-top: 0;">
    <div class="container clearfix">
        ...
        <div class="container-detail-jurnal">
            <center><img src="{{ asset('assets/admin/assets/media/posting') }}/{{$data->image}}" alt="{{$data->getPostingLanguage->judul}}" class="img-header-jurnal"></center>
                        ...
                        <div class="col-md-4" style="float:left">
                            <div class="card mb-2" style="height: 320px;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('dermaster.event.show', $item->getPostingLanguage->seo) }}" class="btn btn-success" style="position: absolute; bottom: 10px; background-color: #28a745; border-color: #28a745;">Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
