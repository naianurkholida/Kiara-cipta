...
<div class="section nobg nobottommargin clearfix" style="margin-top: 0; padding-top: 0;">
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url('jurnal') }}">Jurnal</a></li>
    ...
    <div class="container clearfix">
        ...
        <div class="container-detail-jurnal">
            <center><img src="https://derma-express.com/assets/admin/assets/media/posting/{{ $data->image }}" alt=""
                            ...
                            <div class="col-md-4" style="float:left">
                                <div class="card mb-2" style="height: 410px;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="{{ route('dermaster.jurnal.show', $item->getPostingLanguage->seo) }}"
                                            class="btn btn-success"
                                            style="position: absolute; bottom: 10px;">Selengkapnya</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
