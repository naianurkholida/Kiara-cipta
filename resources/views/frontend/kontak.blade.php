                        ...
                        <form method="POST" action="{{ route('inbox.post') }}">
                            ...
                            <center>
                                <div class="form-group">
                                    <input type="text" class="form-control text-center" id="exampleFormControlInput1" placeholder="Nama Lengkap" name="name" style="border-radius: 10px; width: 600px;">
                                </div> 
                                <div class="form-group">
                                    <input type="email" class="form-control text-center" id="exampleFormControlInput1" placeholder="Masukan alamat email" name="email" style="border-radius: 10px; width: 600px;">
                                </div>
                                <div class="form-group">
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="inbox" style="border-radius: 10px; width: 600px;"></textarea>
                                </div>
