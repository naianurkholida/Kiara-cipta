  ...
  <div id="slider-owl" class="owl-carousel owl-theme">
    @foreach(Helper::slider() as $key=>$row)
      <div class="item" data-hash="{{$key+1}}">
        ...
        {{-- <div class="img-slider" style="background-image: url('http://derma-express.com/storage/82/design-web---rejuvenation-laser.jpg');height:700px;width:10%;background-size: cover;background-repeat: no-repeat;background-position: center;height: 700px;width: 100%;"></div> --}}
      </div>
    @endforeach
  </div>
