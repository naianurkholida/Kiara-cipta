					...
					<nav id="primary-menu" class="style-2 with-arrows">
                        <ul>
                            ...
                            <div id="logo" style="border:0;padding: 0px !important;margin: 0px !important;">
                                <a href="{{ url('/') }}" class="standard-logo"><img src="{{asset('assets/images/LogoDermaExpress.png')}}" alt="DermaexpressLogo" style="height: 75px;"></a>
                                <a href="{{ url('/') }}" class="retina-logo"><img src="{{asset('assets/images/LogoDermaExpress.png')}}" alt="DermaexpressLogo" style="height: 75px;"></a>
                            </div>
                            @foreach(Helper::MenuFrontPage() as $key => $row)
                                @if($key > 3)
                                    @if($row->url != "treatments" && $row->url != "products")
