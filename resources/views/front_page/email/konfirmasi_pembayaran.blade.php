...
<head>
	...
	<title>Mizan Amanah</title>
	<link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700" rel="stylesheet">
	<style type="text/css">
		html {-webkit-text-size-adjust: none; -ms-text-size-adjust: none;}
		@media only screen and (min-device-width: 750px){.table750 {width: 750px !important;}}
								...
								<tr>
									<td align="left" valign="top">
										...
										<a href="#" target="_blank" style="display: block; max-width: 128px;">
											<img src="{{asset('admin/assets/media/img/logo-mizan-amanah-panjang.png')}}" alt="img" width="128" border="0" style="display: block; width: 128px;" />
										</a>
								...
								<tr>
									<td align="left" valign="top">
										<font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">
											<span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">Invoice</span>
										</font>
										...
										<font face="'Source Sans Pro', sans-serif" color="#585858" style="font-size: 24px; line-height: 32px;">
											<table border="0">
												<div class="row">
													<b>Payment Account</b><hr>
													@foreach($bank as $row)
													<div class="col-md-3">
														<div class="form-check">
															<p>
																{{$row->nama_bank}} ({{$row->kode_bank}})<br>
																{{$row->alamat}}<br>
																{{$row->atas_nama}}<br>
																{{$row->no_rekening}}
															</p>
										...
										<table class="mob_btn" cellpadding="0" cellspacing="0" border="0" style="background: #27cbcc; border-radius: 4px;">
											<tr>
												<td align="center" valign="top" style="background: red;"> 
													<a href="{{url('konfirmasi-pembayaran',$nama)}}" target="_blank" style="display: block; border: 1px solid #ff0000; border-radius: 4px; padding: 12px 23px; font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">
														<font face="'Source Sans Pro', sans-serif" color="#ffffff" style="font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">
															<span style="font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">Konfirmasi&nbsp;Pembayaran</span>
														</font>
													</a>
												</td>
											</tr>
											...
											<tr>
												<td align="center" valign="top">
													...
													<font face="'Source Sans Pro', sans-serif" color="#868686" style="font-size: 17px; line-height: 20px;">
														<span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #868686; font-size: 17px; line-height: 20px;">Copyright &copy; {{date('Y')}} All&nbsp;Rights&nbsp;Reserved. By&nbsp;Mizan&nbsp;Amanah!</span>
													</font>
