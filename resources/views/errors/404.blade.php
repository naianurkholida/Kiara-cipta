...
<html lang="en">
	...
	<head>
		<base href="../../../">
		<meta charset="utf-8" />
		<title>MizanAmanah - Error 404 Not Found</title>
		...
		<!--end::Layout Skins -->
		<link rel="shortcut icon" href="{{asset('admin/assets/media/img/logo-mizan-amanah.png')}}" />
	</head>
	...
	<body class="kt-page--loading-enabled kt-page--loading kt-header--fixed kt-header--minimize-topbar kt-header-mobile--fixed kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-subheader--enabled kt-subheader--transparent kt-page--loading">
		...
		<div class="kt-grid kt-grid--ver kt-grid--root kt-page">
			<div class="kt-grid__item kt-grid__item--fluid kt-grid  kt-error-v6" style="background-image: 
			url({{asset('admin/assets/media/error/bg5.jpg')}});">
				<div class="kt-error_container">
					<div class="kt-error_subtitle kt-font-light">
						<h1>404</h1>
						<a href="{{Route('login.form_login')}}"><h3 style="color: black;">Back To Login!!</h3></a>
					</div>
