...
@section('button')
	<a href="{{Route('online_store.index')}}" class="btn btn-info">
...
<div class="card">
	...
	<div class="card-body">
	<form action="{{Route('online_store.update', $data->id)}}" method="POST" enctype="multipart/form-data" id="form_menu">
			{{csrf_field()}}
			<div class="row">
				<div class="col-lg-6">
					<label>Name</label>
					<input type="text" id="os_name" name="os_name" class="form-control" value="{{$data->name}}">
				</div>
				<div class="col-lg-6">
					<label>Link</label>
					<input type="text" id="os_link" name="os_link" class="form-control" value="{{$data->link}}">
				</div>
				<div class="col-lg-12">
