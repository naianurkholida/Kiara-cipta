	...
	<div class="card-body">
		<form action="{{Route('menu.update', $menu->id)}}" method="POST" id="form_menu">
			...
			<div class="row">
				...
				<div class="col-lg-5">
					<label>Label</label>
					<input type="text" name="label" class="form-control" value="{{$menu->label}}" id="label">
				</div>
				<div class="col-lg-5">
					<label>Url</label>
					<input type="text" name="url" class="form-control" value="{{$menu->url}}" id="url"><br>
				</div>
				<div class="col-lg-2">
					<label>Icon</label>
					<input type="text" name="icon" class="form-control" value="{{$menu->icon}}" id="icon">
				</div>
				<div class="col-lg-5">
					<label>Status</label>
				...
				<div class="col-lg-5">
					...
					<input type="text" name="order_num" class="form-control" value="{{$menu->order_num}}" id="order_num"><br>
				</div>
				<div class="col-lg-12">
