...
<div class="card">
	...
	<div class="card-body">
		<form action="{{Route('user.update', $user->id)}}" method="POST" id="form_menu" enctype="multipart/form-data">
			{{csrf_field()}}
			<div class="row">
				<div class="col-lg-6">
				...
				<div class="col-lg-6">
					<label>Email</label>
					<input type="text" name="email" class="form-control" value="{{$user->email}}" id="email"><br>
				</div>
				<div class="col-lg-6">
					<label>Alamat</label>
					<input type="text" name="alamat" class="form-control" value="{{$user->alamat}}" id="alamat">
				</div>
				<div class="col-lg-6">
					<label>Role</label>
				...
				<div class="col-lg-12">
					...
					<div class="kt-avatar kt-avatar--outline kt-avatar--circle-" id="kt_user_edit_avatar">
						<div class="kt-avatar__holder" style="background-image: url({{ asset($user->getFirstMediaUrl('user') == NULL ? 'public/image/default/placeholder.png' : $data) }})"></div>
